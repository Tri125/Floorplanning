...
class SlicingTree:
        ...
        expression_regex = re.compile(r"([A-Za-z]*)([\-\|])([A-Za-z]*)")
        
        def SwapOperatorOperand(self, postfixExpression = "AB-C|D-F|E-"):
                indexOperand = []
                operator = ["-", "|"]
                
                left, operator, right = self.expression_regex.match(postfixExpression).groups()
